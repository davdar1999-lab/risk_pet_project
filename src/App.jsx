...
const bouquets = [
  { id: 1, name: 'Cotton Candy Peonies', price: 2490, rating: 4.9, badge: 'Хит', occasion: 'birthday', day: 'today', style: 'romantic', sizeBase: 'M', image: '/photos/client-bouquet-1.jpg', fallbackImage: '/photos/client-bouquet-1.jpg' },
  { id: 2, name: 'Midnight Tulip Glow', price: 1990, rating: 4.7, badge: 'Сегодня', occasion: 'date', day: 'today', style: 'modern', sizeBase: 'S', image: '/photos/client-bouquet-2.jpg', fallbackImage: '/photos/client-bouquet-2.jpg' },
  { id: 3, name: 'Soft Core Roses', price: 2790, rating: 5.0, badge: 'Премиум', occasion: 'love', day: 'tomorrow', style: 'classic', sizeBase: 'L', image: '/photos/client-bouquet-3.jpg', fallbackImage: '/photos/client-bouquet-3.jpg' }
];
